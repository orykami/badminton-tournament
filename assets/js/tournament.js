...
var groupeJoueurs = {
    "ASBG": [
        new Joueur("Benoît J", genreListe.HOMME, niveauListe.D8, 0),
        new Joueur("Benjamin E", genreListe.HOMME, niveauListe.D9, 0),
        new Joueur("Élodie E", genreListe.FEMME, niveauListe.D9, 0),
        new Joueur("Virgile H", genreListe.HOMME, niveauListe.D8, 0),
        new Joueur("Boris E", genreListe.HOMME, niveauListe.P12, 0),
        new Joueur("Aurore R", genreListe.FEMME, niveauListe.P12, 0),
        new Joueur("Sarah B.", genreListe.FEMME, niveauListe.P12, 0),
        new Joueur("Damien A.", genreListe.HOMME, niveauListe.P12, 0),
        new Joueur("Chantal L.", genreListe.FEMME, niveauListe.P12, 0),
        new Joueur("Yassine B.", genreListe.HOMME, niveauListe.P12, 0),
        new Joueur("Tristan D.", genreListe.HOMME, niveauListe.P12, 0),
        new Joueur("Cédric C.", genreListe.HOMME, niveauListe.P12, 0),
        new Joueur("Mélissa P.", genreListe.FEMME, niveauListe.D8, 0),
        new Joueur("Vuthy S.", genreListe.HOMME, niveauListe.P12, 0),
        new Joueur("Fabrice P.", genreListe.HOMME, niveauListe.D9, 0),
        new Joueur("Patricia P.", genreListe.FEMME, niveauListe.P12, 0),
        new Joueur("Amandine F.", genreListe.FEMME, niveauListe.D9, 0),
        new Joueur("Aline L.", genreListe.FEMME, niveauListe.P10, 0),
        new Joueur("Marie F.", genreListe.FEMME, niveauListe.D9, 0),
